...
try {
  ...
  normal.x();
  normal.z();
  // checkReductionStatus('normal', normal);
} catch (error) {
...
try {
  ...
  // checkReductionStatus('crossref', crossref);
} catch (error) {
...
try {
  ...
  dynamicExport.a();
  dynamicExport.c();
  // checkReductionStatus('dynamic-export', dynamicExport);  
} catch (error) {
...
try {
  ...
  dynamicImport.a();
  // checkReductionStatus('dynamic-import', dynamicImport);
} catch (error) {
...
try {
  ...
  // checkReductionStatus('dynamic-usage', dynamicModule); 
} catch (error) {
...
try {
  ...
  protoExport.b();
  protoExport.d();
  // checkReductionStatus('proto-export', protoExport);  
} catch (error) {
...
try {
  ...
  renameExport.b();
  renameExport.c();
  // checkReductionStatus('rename-export', renameExport);  
} catch (error) {
...
try {
  ...
  // checkReductionStatus('dynamic-module-usage', dynamicModuleUsage);
} catch (error) {
